...
async def start(client, message):
   await message.reply_text(
      ...
      reply_markup=InlineKeyboardMarkup(
         [
            [
               InlineKeyboardButton("❕ ┇ كيفيه استخدام البوت", url=f"https://t.me/musicalgerian"),
               InlineKeyboardButton("", url=f"https://t.me/musicalgerian"),
            ]
         ]
      )
   )
...
async def search(client, message):
    try:
        ...
        while i < 5:
            ...
            i += 1
        await m.edit(text, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("V𝐈𝐒𝐂𝐎  ⁞ D𝐙 B𝐎𝐓𝐒 ࿓ ", url="https://t.me/musicalgerian")]]), disable_web_page_preview=True)
    except Exception as e:
        await m.edit(str(e))
